...
TEST_MODE = False:
  - real DroneController / MAVLink on the Raspberry Pi
  - START / STOP entered in the terminal (for example over SSH)
"""
...
class ConsoleCommandLink:
    """Simple START/STOP command input via the local terminal or SSH."""
...
def build_hardware():
    ...
    # Real hardware path on the Raspberry Pi.
    from drone_controller import DroneController

    controller = DroneController()
    return controller, ConsoleCommandLink()
